...
pub enum FaultPhase {
    ...
    AfterMetadataProtectedFlagsCleared(usize),
    AfterMetadataOwnership(usize),
    AfterMetadataAcl(usize),
    AfterMetadataExtendedAttributes(usize),
    AfterMetadataPermissionMode(usize),
    AfterMetadataModificationTime(usize),
    AfterMetadataBsdFlags(usize),
    AfterMetadataDurability(usize),
    BeforeMetadataVerification(usize),
    AfterMetadataVerification(usize),
