...
|----|--------|------|----------------|---------------|---------------|
| S001 | `docs/product-definition.md` | file | 2026-09-03 | 2026-09-16 | `configuration-and-state.md` |
...
| S003 | `.specify/memory/roadmap.md` | file | 2026-09-03 | 2026-09-16 | `command-line-and-path-selection.md`, `initial-delivery-roadmap-future-features.md`, `roadmap-open-questions-recent.md` |
| S004 | `README.md` | file | 2026-09-03 | 2026-09-16 | `configuration-and-state.md` |
