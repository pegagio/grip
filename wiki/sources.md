...
| S003 | `.specify/memory/roadmap.md` | file | 2026-09-03 | 2026-09-14 | `initial-delivery-roadmap.md`, `initial-delivery-roadmap-later-features.md`, `roadmap-open-questions.md` |
| S004 | `README.md` | file | 2026-09-03 | 2026-09-14 | `filesystem-support-boundaries.md`, `local-development-workflows.md` |
