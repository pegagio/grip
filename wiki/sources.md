...
|----|--------|------|----------------|---------------|---------------|
| S001 | `docs/product-definition.md` | file | 2026-09-03 | 2026-09-10 | `grip-product-model.md`, `mappings-and-managed-membership.md`, `synchronization-and-conflicts.md`, `safety-and-recovery-model.md`, `configuration-and-state.md`, `baseline-classification-and-status.md`, `deletion-retirement-and-recovery.md` |
...
| S003 | `.specify/memory/roadmap.md` | file | 2026-09-03 | 2026-09-10 | `initial-delivery-roadmap.md` |
| S004 | `README.md` | file | 2026-09-03 | 2026-09-10 | `command-line-and-path-selection.md` |
...
| S013 | `specs/010-project-scoped-initialization` | directory | 2026-09-09 | 2026-09-09 | `configuration-and-state.md`, `implementation-and-delivery-direction.md`, `local-development-workflows.md` |
