...
| S003 | `.specify/memory/roadmap.md` | file | 2026-09-03 | 2026-09-16 | `initial-delivery-roadmap.md`, `initial-delivery-roadmap-later-features.md`, `initial-delivery-roadmap-recent-features.md`, `initial-delivery-roadmap-future-features.md`, `command-line-and-path-selection.md`, `roadmap-open-questions.md`, `roadmap-open-questions-recent.md` |
| S004 | `README.md` | file | 2026-09-03 | 2026-09-16 | `local-development-workflows.md`, `mappings-and-managed-membership.md`, `command-line-and-path-selection.md` |
