...
|----|--------|------|----------------|---------------|---------------|
| S001 | `docs/product-definition.md` | file | 2026-09-03 | 2026-09-03 | `grip-product-model.md`, `mappings-and-managed-membership.md`, `synchronization-and-conflicts.md`, `safety-and-recovery-model.md`, `command-line-and-path-selection.md`, `configuration-and-state.md`, `filesystem-support-boundaries.md`, `implementation-and-delivery-direction.md` |
...
| S003 | `.specify/memory/roadmap.md` | file | 2026-09-03 | 2026-09-06 | `initial-delivery-roadmap.md`, `roadmap-open-questions.md`, `implementation-and-delivery-direction.md` |
| S004 | `README.md` | file | 2026-09-03 | 2026-09-06 | `command-line-and-path-selection.md`, `mappings-and-managed-membership.md`, `filesystem-support-boundaries.md`, `configuration-and-state.md`, `synchronization-and-conflicts.md`, `safety-and-recovery-model.md` |
