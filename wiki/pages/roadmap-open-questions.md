...
- **002:** define mapping lifecycle syntax, decide whether tracking only records intent or may perform explicitly previewed initial synchronization, and enumerate rejected recursive topologies. (S003)
