...
- **005 and 008 (partially resolved):** Feature 005 defines private recovery creation, preservation, binding, and reporting for replacement actions. Feature 008 retains backup inspection, cleanup, rollback, and broader recovery when registry or baseline state is missing, corrupt, unreadable, or inconsistent. (S003)
